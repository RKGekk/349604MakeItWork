...
C2::C2(ID3D11Device* device, ID3D11DeviceContext* deviceContext, CameraClass* cam, DirectX::XMFLOAT4X4* world) : Drawable(world), m_camera(cam) {

	IndexedTriangleList model = IndexedTriangleList::LoadNormals("c2.obj");
...
void C2::Update(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float dt, float tt) {
