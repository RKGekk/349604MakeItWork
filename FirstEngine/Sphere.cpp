...
Sphere::Sphere(ID3D11Device* device, ID3D11DeviceContext* deviceContext, CameraClass* cam, DirectX::XMFLOAT4X4* world) : Drawable(world), m_camera(cam) {

	float planetRadius = 1.0f;

	GeometryGenerator::MeshData sphere;
	GeometryGenerator geoGen;
	geoGen.CreateSphere(planetRadius, 16, 16, sphere);
...
void Sphere::Update(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float dt, float tt) {
