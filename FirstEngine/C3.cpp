...
C3::C3(ID3D11Device* device, ID3D11DeviceContext* deviceContext, CameraClass* cam, DirectX::XMFLOAT4X4* world) : Drawable(world), m_camera(cam) {

	IndexedTriangleList model = IndexedTriangleList::LoadNormals("c3.obj");
	...
	mt.material.Ambient = DirectX::XMFLOAT4(0.2f, 0.2f, 0.2f, 1.0f);
	mt.material.Diffuse = DirectX::XMFLOAT4(0.482353f, 0.705882f, 0.811765f, 1.0f);
	mt.material.Specular = DirectX::XMFLOAT4(0.8f, 0.8f, 0.8f, 96.0f);
...
void C3::Update(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float dt, float tt) {
