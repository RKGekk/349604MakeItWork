...
class RadioCamera : public Drawable {
public:
	RadioCamera(ID3D11Device* device, ID3D11DeviceContext* deviceContext, CameraClass* cam, DirectX::XMFLOAT4X4* world);
...
private:
	...
	PixelConstantBufferPO* m_cbps0;
	PixelConstantBufferPF* m_cbps1;
