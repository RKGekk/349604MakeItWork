...
C1::C1(ID3D11Device* device, ID3D11DeviceContext* deviceContext, CameraClass* cam, DirectX::XMFLOAT4X4* world) : Drawable(world), m_camera(cam) {

	IndexedTriangleList model = IndexedTriangleList::LoadNormals("c1.obj");
...
void C1::Update(ID3D11Device* device, ID3D11DeviceContext* deviceContext, float dt, float tt) {
